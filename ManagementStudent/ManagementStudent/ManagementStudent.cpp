...
void student::getdata()
{
	...
	cin >> chemistry;
	cout << "\n	Nhap diem mon Toan hoc : ";
	cin >> mathematics;
	cout << "\n Nhap diem mon Ngoai ngu : ";
	cin >> english;
	cout << "\n Nhap diem mon Tin hoc : ";
	cin >> comscience;
	calculate();
}
...
void modify_student(int n)
{
	...
	while (!File.eof() && found == false)
	{
		...
		{
			st.showdata();
			cout << "\n\nVui long nhap thong tin chinh sua cua Sinh vien " << endl;
			st.getdata();
...
void class_result()
{
	...
	cout << "\n\n\t\tALL STUDENTS RESULT \n\n";
	cout << "==========================================================\n";
	cout << "R.No       Name        VL   HH   ToH   NN   Tin   %age   Grade" << endl;
	cout << "==========================================================\n";
	while (inFile.read(reinterpret_cast<char*> (&st), sizeof(student)))
	{
		st.show_tabular();
...
int main()
{
	...
	do
	{
		...
		cout << "\t==============================================";
		cout << "\n\n\t1.Tao moi Sinh vien";
		cout << "\n\n\t2.Hien thi du lieu Sinh vien";
		cout << "\n\n\t3.Tim kiem du lieu Sinh vien ";
		cout << "\n\n\t4.Chinh sua du lieu cua sinh vien";
		cout << "\n\n\t5.Xoa du lieu cua Sinh vien";
		cout << "\n\n\t6. Hien thi du lieu nguon ";
		cout << "\n\n\t7. EXIT";
		cout << "\n\n\t==========================================";
		cout << "\n\n\tVui long lua chon (1-7): ";
		cin >> ch;
		system("cls");
		switch (ch)
		{
		...
		case '3':	cout << "\n\n\t Vui long nhap  ID cua Sinh vien : "; cin >> num;
